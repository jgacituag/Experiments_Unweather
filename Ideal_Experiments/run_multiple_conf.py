...
def run_wrf(args,conf=conf):
    ...
    conf = conf.conf
    conf['expname']   = 'TEST_4_vars'
    conf['run_num']   = i
    conf['modelpath'] = '../comp_model/em_quarter_ss'
    conf['datapath']  = '../DATA/'
    ...
    conf['stability_factor_height'] = 2500+(param4*(10000-2500)) #Height of maximum warming / cooling. (tipical range [2500 , 10000 ] )
    ...
    #  CALL WRF MODEL
    #############################################################################################
    conf['plot_types'] = ['init_sounding']
    print('total_shear_depth : '+str(conf['total_shear_depth']))
    print('int_total_shear : '+str(conf['int_total_shear']))
    print('curved_shear_per : '+str(conf['curved_shear_per']))
    print('stability_factor_height : '+str(conf['stability_factor_height']))
